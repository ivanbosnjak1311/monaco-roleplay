...
hook OnGameModeInit() {
    ...
    TextDrawFont(LoginGUI[0], TEXT_DRAW_FONT_2);
    ...
    TextDrawAlignment(LoginGUI[0], TEXT_DRAW_ALIGN_LEFT);
    ...
    TextDrawFont(LoginGUI[1], TEXT_DRAW_FONT_2);
    ...
    TextDrawAlignment(LoginGUI[1], TEXT_DRAW_ALIGN_LEFT);
