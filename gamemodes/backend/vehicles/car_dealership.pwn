...
stock ToggleDealershipUI(playerid, bool:toggle = true) {
    if (toggle) {
        Dealership_PTD[playerid][0] = CreatePlayerTextDraw(playerid, 124.000, 140.000, "OTTOS CARS");
        PlayerTextDrawLetterSize(playerid, Dealership_PTD[playerid][0], 0.283, 1.200);
        PlayerTextDrawTextSize(playerid, Dealership_PTD[playerid][0], 400.000, 137.000);
        PlayerTextDrawAlignment(playerid, Dealership_PTD[playerid][0], TEXT_DRAW_ALIGN_CENTER);
        ...
        PlayerTextDrawFont(playerid, Dealership_PTD[playerid][0], TEXT_DRAW_FONT_2);
        PlayerTextDrawSetProportional(playerid, Dealership_PTD[playerid][0], true);

        Dealership_PTD[playerid][1] = CreatePlayerTextDraw(playerid, 111.000, 172.000, "Infernus");
        PlayerTextDrawLetterSize(playerid, Dealership_PTD[playerid][1], 0.283, 1.050);
        PlayerTextDrawTextSize(playerid, Dealership_PTD[playerid][1], 400.000, 17.000);
        PlayerTextDrawAlignment(playerid, Dealership_PTD[playerid][1], TEXT_DRAW_ALIGN_LEFT);
        ...
        PlayerTextDrawFont(playerid, Dealership_PTD[playerid][1], TEXT_DRAW_FONT_2);
        PlayerTextDrawSetProportional(playerid, Dealership_PTD[playerid][1], true);

        Dealership_PTD[playerid][2] = CreatePlayerTextDraw(playerid, 111.000, 191.000, "BENZIN");
        PlayerTextDrawLetterSize(playerid, Dealership_PTD[playerid][2], 0.283, 1.050);
        PlayerTextDrawTextSize(playerid, Dealership_PTD[playerid][2], 400.000, 17.000);
        PlayerTextDrawAlignment(playerid, Dealership_PTD[playerid][2], TEXT_DRAW_ALIGN_LEFT);
        ...
        PlayerTextDrawFont(playerid, Dealership_PTD[playerid][2], TEXT_DRAW_FONT_2);
        PlayerTextDrawSetProportional(playerid, Dealership_PTD[playerid][2], true);

        Dealership_PTD[playerid][3] = CreatePlayerTextDraw(playerid, 54.000, 228.000, "ld_beat:chit");
        PlayerTextDrawLetterSize(playerid, Dealership_PTD[playerid][3], 0.600, 2.000);
        PlayerTextDrawTextSize(playerid, Dealership_PTD[playerid][3], 30.000, 30.000);
        PlayerTextDrawAlignment(playerid, Dealership_PTD[playerid][3], TEXT_DRAW_ALIGN_LEFT);
        ...
        PlayerTextDrawFont(playerid, Dealership_PTD[playerid][3], TEXT_DRAW_FONT_SPRITE_DRAW);
        PlayerTextDrawSetProportional(playerid, Dealership_PTD[playerid][3], true);

        Dealership_PTD[playerid][4] = CreatePlayerTextDraw(playerid, 153.000, 229.000, "Preview_Model");
        PlayerTextDrawLetterSize(playerid, Dealership_PTD[playerid][4], 0.600, 2.000);
        PlayerTextDrawTextSize(playerid, Dealership_PTD[playerid][4], 28.500, 28.000);
        PlayerTextDrawAlignment(playerid, Dealership_PTD[playerid][4], TEXT_DRAW_ALIGN_LEFT);
        ...
        PlayerTextDrawFont(playerid, Dealership_PTD[playerid][4], TEXT_DRAW_FONT_MODEL_PREVIEW);
        ...
        PlayerTextDrawSetPreviewRot(playerid, Dealership_PTD[playerid][4], -10.000, 0.000, 90.000, 1.000);
        PlayerTextDrawSetPreviewVehicleColours(playerid, Dealership_PTD[playerid][4], 1, 1);

        Dealership_PTD[playerid][5] = CreatePlayerTextDraw(playerid, 69.000, 258.000, "Svijetlo Zelena");
        PlayerTextDrawLetterSize(playerid, Dealership_PTD[playerid][5], 0.191, 0.750);
        PlayerTextDrawTextSize(playerid, Dealership_PTD[playerid][5], 400.000, 152.000);
        PlayerTextDrawAlignment(playerid, Dealership_PTD[playerid][5], TEXT_DRAW_ALIGN_CENTER);
        ...
        PlayerTextDrawFont(playerid, Dealership_PTD[playerid][5], TEXT_DRAW_FONT_3);
        PlayerTextDrawSetProportional(playerid, Dealership_PTD[playerid][5], true);

        Dealership_PTD[playerid][6] = CreatePlayerTextDraw(playerid, 168.000, 258.000, "Switch");
        PlayerTextDrawLetterSize(playerid, Dealership_PTD[playerid][6], 0.191, 0.750);
        PlayerTextDrawTextSize(playerid, Dealership_PTD[playerid][6], 400.000, 152.000);
        PlayerTextDrawAlignment(playerid, Dealership_PTD[playerid][6], TEXT_DRAW_ALIGN_CENTER);
        ...
        PlayerTextDrawFont(playerid, Dealership_PTD[playerid][6], TEXT_DRAW_FONT_3);
        PlayerTextDrawSetProportional(playerid, Dealership_PTD[playerid][6], true);

        Dealership_PTD[playerid][7] = CreatePlayerTextDraw(playerid, 29.000, 277.000, "Nakon sto odaberete model i odgovarajuce specifikacije, mozete preci na pregled ugovora za vozilo. Cijena ovog vozila je: ~g~$1");
        PlayerTextDrawLetterSize(playerid, Dealership_PTD[playerid][7], 0.191, 0.750);
        PlayerTextDrawTextSize(playerid, Dealership_PTD[playerid][7], 218.000, 242.000);
        PlayerTextDrawAlignment(playerid, Dealership_PTD[playerid][7], TEXT_DRAW_ALIGN_LEFT);
        ...
        PlayerTextDrawFont(playerid, Dealership_PTD[playerid][7], TEXT_DRAW_FONT_1);
        PlayerTextDrawSetProportional(playerid, Dealership_PTD[playerid][7], true);

        Dealership_PTD[playerid][8] = CreatePlayerTextDraw(playerid, 123.000, 318.000, "Pregled ugovora: ~g~$1");
        PlayerTextDrawLetterSize(playerid, Dealership_PTD[playerid][8], 0.187, 0.850);
        PlayerTextDrawTextSize(playerid, Dealership_PTD[playerid][8], 18.000, 188.000);
        PlayerTextDrawAlignment(playerid, Dealership_PTD[playerid][8], TEXT_DRAW_ALIGN_CENTER);
        ...
        PlayerTextDrawFont(playerid, Dealership_PTD[playerid][8], TEXT_DRAW_FONT_1);
